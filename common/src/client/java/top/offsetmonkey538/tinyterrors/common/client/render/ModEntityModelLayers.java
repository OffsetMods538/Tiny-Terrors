...
import top.offsetmonkey538.tinyterrors.common.mixin.client.render.entity.model.EntityModelsMixin;
...
public final class ModEntityModelLayers {
    ...
    public static final EntityModelLayer WITHER_SKELETON_BABY                = register("wither_skeleton_baby", "main",        SkeletonEntityModel::getTexturedModelData,                                                    16.0f/* TODO: , ModelTransformer.scaling(1.2f) */);
    public static final EntityModelLayer WITHER_SKELETON_BABY_INNER_ARMOR    = register("wither_skeleton_baby", "inner_armor", () -> INNER_ARMOR,                                                                            16.0f/* TODO: , ModelTransformer.scaling(1.2f) */);
    public static final EntityModelLayer WITHER_SKELETON_BABY_OUTER_ARMOR    = register("wither_skeleton_baby", "outer_armor", () -> OUTER_ARMOR,                                                                            16.0f/* TODO: , ModelTransformer.scaling(1.2f) */);


    /* TODO: oh god zombies don't even use a different model for the baby wtf am I going to do to render them????
    ...
    private static EntityModelLayer register(final String id, final String layerId, final EntityModelLayerRegistry.TexturedModelDataProvider baseProvider, final float headOffset, ModelTransform transformer) {
...
EntityModels
     ...
     */
    private static EntityModelLayer register(final String id, final String layerId, final EntityModelLayerRegistry.TexturedModelDataProvider baseProvider, final float headOffset) {
        return register(id, layerId, baseProvider, headOffset, null);
    }
    private static EntityModelLayer register(final String id, final String layerId, final EntityModelLayerRegistry.TexturedModelDataProvider baseProvider, final float headOffset, ModelTransform transformer) {
        final EntityModelLayer layer = new EntityModelLayer(id(id), layerId);

        EntityModelLayerRegistry.registerModelLayer(layer, baseProvider);
